...
public class ChangeCredentialsScreen extends JFrame implements ActionListener {
    ...
    public ChangeCredentialsScreen() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(ChangeCredentialsScreen.class.getResource("icon.png"))); // Change the icon
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == saveButton) {
            ...
            try {
                PrintWriter writer = new PrintWriter(new File(LoginScreen.class.getResource("credentials.txt").getPath()));
